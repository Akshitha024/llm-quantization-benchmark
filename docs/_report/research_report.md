---
title: "llm-quantization-benchmark: Side-by-side LLM quantization benchmark on perplexity, size, memory, latency"
...
Side-by-side LLM quantization benchmark on perplexity, size, memory, latency

This report presents the methodology, dataset, evaluation results, and analysis
of the llm-quantization-benchmark project. We describe the design choices, baseline
...
Side-by-side LLM quantization benchmark on perplexity, size, memory, latency The remainder of this section motivates the choice of approach.
